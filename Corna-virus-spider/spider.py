...
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) '
                         'AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36 Edg/105.0.1343.27'}
...
def setsubpage(ws, wb, home_page, page_count, SUBPAGE_EXCEL):
...
def new_confirmed_cases(data,row_count, NEW_CONFIRMED_CASES_DATA_EXCEL):
    try:
...
def new_asymptomatic_infections(data,row_count, NEW_ASYMPTOMATIC_INFECTIONS_DATA_EXCEL):
    try:
